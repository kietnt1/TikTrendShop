        ...
        <div class="nav-header bg-white shadow-xs border-0" >
            ...
            <form action="#" class="float-left header-search">
                <div class="form-group mb-0 icon-input">
                    ...
                    <input type="text" placeholder="Start typing to search.."
                        class="bg-grey border-0 lh-32 pt-2 pb-2 ps-5 pe-3 font-xssss fw-500 rounded-xl w350 theme-dark-bg"></input>
                </div>
            </form>
            ...
            <div class="dropdown-menu dropdown-menu-end p-4 rounded-3 border-0 shadow-lg"
                ...
                <div class="card bg-transparent-card w-100 border-0 ps-5 mb-3">
                    <img src="images/user-8.png" alt="user" class="w40 position-absolute left-0"></img>
                ...
                <div class="card bg-transparent-card w-100 border-0 ps-5 mb-3">
                    <img src="images/user-4.png" alt="user" class="w40 position-absolute left-0"></img>
                ...
                <div class="card bg-transparent-card w-100 border-0 ps-5 mb-3">
                    <img src="images/user-7.png" alt="user" class="w40 position-absolute left-0"></img>
                ...
                <div class="card bg-transparent-card w-100 border-0 ps-5">
                    <img src="images/user-6.png" alt="user" class="w40 position-absolute left-0"></img>
                ...
                <div class="dropdown-menu-settings switchcolor-wrap">
                    ...
                    <ul>
                        <li>
                            <label class="item-radio item-content">
                                <input type="radio" name="color-radio" value="red" checked=""></input><i class="ti-check"></i>
                                <span class="circle-color bg-red" style={{ backgroundColor: '#ff3b30' }}></span>
                            </label>
                        </li>
                        <li>
                            <label class="item-radio item-content">
                                <input type="radio" name="color-radio" value="green"></input><i class="ti-check"></i>
                                <span class="circle-color bg-green" style={{ backgroundColor: '#4cd964' }}></span>
                            </label>
                        </li>
                        <li>
                            <label class="item-radio item-content">
                                <input type="radio" name="color-radio" value="blue" checked=""></input><i class="ti-check"></i>
                                <span class="circle-color bg-blue" style={{ backgroundColor: '#132977' }}></span>
                            </label>
                        </li>
                        <li>
                            <label class="item-radio item-content">
                                <input type="radio" name="color-radio" value="pink"></input><i class="ti-check"></i>
                                <span class="circle-color bg-pink" style={{ backgroundColor: '#ff2d55' }}></span>
                            </label>
                        </li>
                        <li>
                            <label class="item-radio item-content">
                                <input type="radio" name="color-radio" value="yellow"></input><i class="ti-check"></i>
                                <span class="circle-color bg-yellow" style={{ backgroundColor: '#ffcc00' }}></span>
                            </label>
                        </li>
                        <li>
                            <label class="item-radio item-content">
                                <input type="radio" name="color-radio" value="orange"></input><i class="ti-check"></i>
                                <span class="circle-color bg-orange" style={{ backgroundColor: '#ff9500' }}></span>
                            </label>
                        </li>
                        <li>
                            <label class="item-radio item-content">
                                <input type="radio" name="color-radio" value="gray"></input><i class="ti-check"></i>
                                <span class="circle-color bg-gray" style={{ backgroundColor: '#8e8e93' }}></span>
                            </label>
                        </li>

                        <li>
                            <label class="item-radio item-content">
                                <input type="radio" name="color-radio" value="brown"></input><i class="ti-check"></i>
                                <span class="circle-color bg-brown" style={{ backgroundColor: '#D2691E' }}></span>
                            </label>
                        </li>
                        <li>
                            <label class="item-radio item-content">
                                <input type="radio" name="color-radio" value="darkgreen"></input><i class="ti-check"></i>
                                <span class="circle-color bg-darkgreen" style={{ backgroundColor: '#228B22' }}></span>
                            </label>
                        </li>
                        <li>
                            <label class="item-radio item-content">
                                <input type="radio" name="color-radio" value="deeppink"></input><i class="ti-check"></i>
                                <span class="circle-color bg-deeppink" style={{ backgroundColor: '#FFC0CB' }}></span>
                            </label>
                        </li>
                        <li>
                            <label class="item-radio item-content">
                                <input type="radio" name="color-radio" value="cadetblue"></input><i class="ti-check"></i>
                                <span class="circle-color bg-cadetblue" style={{ backgroundColor: '#5f9ea0' }}></span>
                            </label>
                        </li>
                        <li>
                            <label class="item-radio item-content">
                                <input type="radio" name="color-radio" value="darkorchid"></input><i class="ti-check"></i>
                                <span class="circle-color bg-darkorchid" style={{ backgroundColor: '#9932cc' }}></span>
                            </label>
                        </li>
                    </ul>
                    ...
                    <div class="card bg-transparent-card border-0 d-block mt-3">
                        ...
                        <div class="d-inline float-right mt-1">
                            <label class="toggle toggle-menu-color"><input type="checkbox"></input><span
                    ...
                    <div class="card bg-transparent-card border-0 d-block mt-3">
                        ...
                        <div class="d-inline float-right mt-1">
                            <label class="toggle toggle-menu"><input type="checkbox"></input><span
                                class="toggle-icon"></span></label>
                        </div>
                    </div>
                    <div class="card bg-transparent-card border-0 d-block mt-3">
                        ...
                        <div class="d-inline float-right mt-1">
                            <label class="toggle toggle-dark"><input type="checkbox"></input><span
                                class="toggle-icon"></span></label>
                        </div>
                    </div>
